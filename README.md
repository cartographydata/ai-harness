...
| `2-model.ts` | Model | Calls any Claude model with a prompt, returns a string. |
...
| `2-model.ts` | Model client | Anthropic API via `@anthropic-ai/sdk`. Swap models by changing one string. |
